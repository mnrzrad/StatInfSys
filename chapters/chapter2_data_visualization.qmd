...
For the following datasets (data description: [DataDescriptions.pdf](https://instruction.bus.wisc.edu/jfrees/jfreesbooks/regression%20modeling/bookwebdec2010/DataDescriptions.pdf)):

- [CeoCompensation](https://instruction.bus.wisc.edu/jfrees/jfreesbooks/regression%20modeling/bookwebdec2010/CSVData/CeoCompensation.csv)
- [MassBodilyInjury](https://instruction.bus.wisc.edu/jfrees/jfreesbooks/regression%20modeling/bookwebdec2010/CSVData/MassBodilyInjury.csv)
- [Refrigerator](https://instruction.bus.wisc.edu/jfrees/jfreesbooks/regression%20modeling/bookwebdec2010/CSVData/Refrigerator.csv)
...
- For outlier analysis, identify any unusual observations that may affect your results.
 scatter plots to visualize potential outliers.
