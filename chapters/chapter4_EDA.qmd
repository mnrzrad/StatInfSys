...
Besides this formula, skewness can also be estimated using the mean, median, or mode, especially when full raw data are not available.
...
While their numerical values may differ, they usually agree in the direction of skew.
