...
required_packages <- c("cluster", "lsa", "GGally", "factoextra", "stats", "tibble", 'dplyr', 'kmed', 'hopkins', 'fpc', 'mclust', 'clValid', "jpeg", "ggplot2", "grid", "tidyverse", "gridExtra")
...
fviz_nbclust(sample_img, pam, method = "wss") +
  ggtitle("Elbow Method — Optimal Number of Colors")
```
...
set.seed(123)
fviz_nbclust(sample_img, pam, method = "silhouette") +
...
set.seed(123)
fviz_nbclust(sample_img, pam, method = "gap_stat", nboot = 30) +
  ggtitle("Gap Statistic — Cluster Quality")
```